$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '用户账号', name: 'userName', index: 'userName', width: 120},
            {label: '状态', name: 'isDeleted', index: 'isDeleted', width: 60, formatter: statusFormatter},
            {label: '申请时间', name: 'createTime', index: 'createTime', width: 60},
        ],
        height: 700,
        rowNum: 10,
        rowList: [10, 20, 50],
